...
;
(function (env, window, document, undefined) {
    ...
    env.getBrowserInfo = getBrowserInfo;
    ...
    env.getMobileSystem = getMobileSystem;
    ...
    env.getAndroidVersion = getAndroidVersion;


})(window.env = window.env || {}, window, document);
